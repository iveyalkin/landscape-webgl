...
// using UnityEditor;
//
// namespace IV.PAL.Editor
// {
//     [CustomEditor(typeof(LayersController))]
//     public class AmbienceControllerEditor : UnityEditor.Editor
//     {
...
//                     "Autopilot starts and stops random tracks according to the specified preferences",
//                     MessageType.None);
//             }
//
...
//                 if (showDetailedInfo)
//                 {
//                     EditorGUILayout.HelpBox("If enabled, autopilot will cross-fade between random tracks",
//                         MessageType.None);
//                 }
//
...
//             {
//                 Undo.RecordObject(target, "AmbienceController");
//                 t.volume = volume;
...
//
//             EditorGUILayout.Separator();
//             EditorGUILayout.HelpBox($"{numTracks} tracks detected.",
